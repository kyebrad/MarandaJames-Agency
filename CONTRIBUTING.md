...
By participating in this project, you are expected to uphold our Code of Conduct. We are committed to providing a welcoming and inspiring community for all.
...
- Ensure all new components are accessible (WCAG compliant) and include appropriate ARIA attributes.
- Use TypeScript for all new code and ensure strict type checking passes.

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-2">
            ...
            <p className="text-olive-light text-sm max-w-md mb-8 leading-relaxed">
            ...
            <div className="p-6 bg-olive-dark rounded-xl border border-white/5 relative overflow-hidden">
              <Heart className="absolute -right-4 -bottom-4 w-24 h-24 text-white/5" />
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-olive-light">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm text-olive-light">
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-olive-light">
